  ...
  return (
    <section id="kontak" className="py-24 md:py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto">
          ...
          <ScrollReveal direction="left" className="h-full">
            <div className="group h-full relative p-1 rounded-[2.5rem] bg-gradient-to-b from-border/50 to-transparent hover:from-emerald-500/30 transition-all duration-500">
              <Card className="h-full border-0 shadow-xl overflow-hidden rounded-[2.2rem] bg-background/80 backdrop-blur-xl flex flex-col transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-emerald-500/10">
                <div className="p-6 md:p-8 flex items-start justify-between gap-4 z-10 relative">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <div className="p-2 bg-emerald-500/10 rounded-xl text-emerald-600">
                        <MapPin className="h-5 w-5" />
                      </div>
                      <h4 className="font-extrabold text-xl text-foreground font-outfit uppercase tracking-tight">Sembar Adventure</h4>
                    </div>
                    <p className="text-sm text-muted-foreground font-medium pl-11">Basecamp Rafting Utama, Cafe & Outbound</p>
                  </div>
                  <a 
                    href="https://maps.app.goo.gl/YourSembarLinkHere" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="shrink-0 p-3 bg-gray-100 hover:bg-emerald-50 text-gray-600 hover:text-emerald-600 rounded-2xl transition-colors hidden sm:flex items-center gap-2 text-xs font-bold uppercase tracking-wide"
                  >
                    <span>Buka Maps</span>
                ...
                <div className="relative w-full h-[350px] md:h-[400px] mt-auto">
                ...
                <div className="p-6 md:p-8 flex items-start justify-between gap-4 z-10 relative">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-extrabold text-xl text-foreground font-outfit uppercase tracking-tight">Grand Titik Kumpul</h4>
                    </div>
                    <p className="text-sm text-muted-foreground font-medium pl-11">Titik pertemuan alternatif untuk grup besar</p>
                  </div>
                  <a 
                    href="https://maps.app.goo.gl/YourKumpulLinkHere" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="shrink-0 p-3 bg-gray-100 hover:bg-teal-50 text-gray-600 hover:text-teal-600 rounded-2xl transition-colors hidden sm:flex items-center gap-2 text-xs font-bold uppercase tracking-wide"
                  >
                    <span>Buka Maps</span>
                    <ExternalLink className="h-4 w-4" />
                  </a>
