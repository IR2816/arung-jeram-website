...
export function WeatherWidget() {
  ...
  if (loading) {
    return (
      <div className="fixed bottom-4 left-4 z-50 glass-dark bg-black/40 backdrop-blur-xl border border-white/20 p-3 rounded-2xl shadow-2xl flex items-center justify-center w-40 h-16">
