        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto grid max-w-6xl items-start gap-8 md:gap-10">
            ...
            <div className="text-white max-w-3xl">
              ...
              <h1
                className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] tracking-tighter animate-fade-in-up font-outfit"
              ...
              {subtitle && (
                <p
                  className="mt-4 sm:mt-5 text-base md:text-lg text-emerald-50/80 leading-relaxed font-medium tracking-wide max-w-2xl animate-fade-in-up"
              ...
              >
                <a href={ctaHref}>
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-8 h-12 rounded-full shadow-lg shadow-emerald-500/20 transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/40 hover:-translate-y-0.5 group"
                  >
                    {ctaText}
                ...
                <a href={secondaryCtaHref}>
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full sm:w-auto border-white/20 bg-white/5 text-white hover:bg-white/10 px-8 h-12 rounded-full backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5"
                  >
                    {secondaryCtaText}
                  </Button>
                </a>
