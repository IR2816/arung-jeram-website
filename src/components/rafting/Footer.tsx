        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex gap-4">
              {[
                { icon: Instagram, href: "https://www.instagram.com/sembar_adventure/", bg: "hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500" },
              ].map((social, i) => (
              ...
              <a href="https://www.tiktok.com/@sembar_adventure" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center transition-all duration-300 hover:bg-black group">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex flex-col gap-6">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <a href={getWhatsAppUrl()} target="_blank" rel="noopener noreferrer" className="text-xs font-bold hover:text-emerald-400 transition-colors">Kontak Kami</a>
                </div>
              </div>
              <div className="flex flex-col gap-6">
                <div className="flex gap-4 items-center">
