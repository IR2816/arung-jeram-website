...
const MediaContent = ({ mediaType }: { mediaType: 'video' | 'image' }) => {
  ...
  return (
    <div className='w-full max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-8'>
      ...
      <p className='text-base sm:text-lg mb-6 sm:mb-8 text-black dark:text-white leading-relaxed'>
...
const Demo = () => {
  ...
  return (
    <div className='min-h-screen'>
      <div className='fixed top-3 right-3 sm:top-4 sm:right-4 z-50 flex gap-2 md:gap-3'>
        <button
